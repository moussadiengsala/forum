...
func (a *Auth) Register(w http.ResponseWriter, r *http.Request) {
	...
	if codeAuthProvider != "" {
		var provider = externals.GetProvider(r)
		if provider.ClientID != "" {
			// var data, err = externals.GetUserInfos(codeAuthProvider, provider)
			var data, err = externals.GetUserInfos(codeAuthProvider, provider)
	...
	response.Data = map[string]string{
		"GOOGLE_AUTH": externals.GoogleAuth.SetAuthURL(),
		"GITHUB_AUTH": externals.GithubAuth.SetAuthURL(),
	}
